// =========================================================
// نعمان موبائل ریپیئرنگ سینٹر — انٹرایکشنز (اردو ورژن)
// =========================================================
...
(function(){
  ...
  const jobs = [
    { device: 'iPhone 13',          issue: 'ٹوٹی ہوئی اسکرین' },
    { device: 'Samsung Galaxy S23', issue: 'بیٹری جلدی ختم ہونا' },
    { device: 'Redmi Note 12',      issue: 'چارج نہیں ہو رہا' },
    { device: 'OnePlus Nord',       issue: 'پانی سے خراب' },
    { device: 'Vivo Y-سیریز',       issue: 'اسپیکر کام نہیں کر رہا' },
    { device: 'Oppo A-سیریز',       issue: 'لوگو اسکرین پر اٹکا ہوا' },
  ];
